...
let OrdersController = class OrdersController {
    ...
    create(createOrderDto, req) {
        (0, ownership_1.assertSelfOrAdmin)(req.user, createOrderDto.consumerId);
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], OrdersController.prototype, "findByConsumer", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], OrdersController.prototype, "findByProvider", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
