...
> = {
  ...
  pitta: {
    ...
    balancedBy: "Cooling practices, moonlight meditation, coconut-oil treatments and gentle flow yoga.",
  },
  kapha: {
    name: "Kapha",
    element: "Earth & Water",
    qualities: "Calm, steady, nurturing — governs structure, stability and immunity.",
    balancedBy: "Invigorating movement, dry massage (Garshana), warming spices and energising breathwork.",
  },
};
